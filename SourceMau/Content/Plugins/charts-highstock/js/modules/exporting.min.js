...
*/
(function (f) {
    var A = f.Chart, t = f.addEvent, B = f.removeEvent, l = f.createElement, o = f.discardElement, v = f.css, k = f.merge, r = f.each, p = f.extend, D = Math.max, j = document, C = window, E = f.isTouchDevice, F = f.Renderer.prototype.symbols, s = f.getOptions(), y; p(s.lang, { printChart: "In biểu đồ", downloadPNG: "Tải hình PNG", downloadJPEG: "Tải hình JPEG", downloadPDF: "Tải file PDF", downloadSVG: "Tải hình vector SVG", contextButtonTitle: "Menu biểu đồ" }); s.navigation = {
        menuStyle: {
