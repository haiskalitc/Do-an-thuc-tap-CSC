...
(function() {
    ...
    CKEDITOR.event || (CKEDITOR.event = function() {}, CKEDITOR.event.implementOn = function(a) {
        ...
        return{
            ...
            on: function(b, f, d, e, l) {
                function i(a, m, t, j) {
                    a = { name: b, sender: this, editor: a, data: m, listenerData: e, stop: t, cancel: j, removeListener: g };
    ...
    (function() {
        ...
        CKEDITOR.tools = {
            ...
            extend: function(a) {
                ...
                for (var c = 1; c < f; c++) {
                    var e = arguments[c], j;
                    for (j in e)if (d === true || a[j] == null)if (!b || j in b)a[j] = e[j];
                }
                return a;
            },
            ...
            buildStyleHtml: function(a) {
                for (var a = [].concat(a), f, d = [], b = 0; b < a.length; b++)if (f = a[b])/@
                import | [{}] / .;
                test(f) ? d.push("<style>" + f + "</style>") : d.push('<link type="text/css" rel=stylesheet href="' + f + '">');
                return d.join("");
            },
            htmlEncode: function(a) { return("" + a).replace(b, "&amp;").replace(c, "&gt;").replace(f, "&lt;"); },
            htmlDecode: function(a) { return a.replace(h, "&").replace(l, ">").replace(i, "<"); },
            htmlEncodeAttr: function(a) { return a.replace(d, "&quot;").replace(f, "&lt;").replace(c, "&gt;"); },
            htmlDecodeAttr: function(a) { return a.replace(g, '"').replace(i, "<").replace(l, ">"); },
            ...
            addFunction: function(f, d) { return a.push(function() { return f.apply(d || this, arguments); }) - 1; },
            ...
            enableHtml5Elements: function(a, f) {
                for (var d = [
                             "abbr", "article", "aside", "audio", "bdi", "canvas", "data",
    ...
    (function() {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            removeStyle: function(a) {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], i = 0; i < c.length; i++)
                        if (e)for (var g = 0; g < e.length; g++)b.push([a, c[i], e[g]].join("-"));
            ...
            scrollIntoParent: function(a, b, c) {
                ...
                function y(a, b) { return parseInt(a.getComputedStyle("margin-" + b) || 0, 10) || 0; }
    ...
    (function() {
        function a(a, b) {
            ...
            if (a && !this._.guardRTL) {
                ...
                this._.guardRTL = function(a, b) { return(!b || !g.equals(a)) && (!D || !a.equals(D)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root)); };
            }
            var i = a ? this._.guardRTL : this._.guardLTR;
            h = E ? function(a, b) { return i(a, b) === false ? false : E(a, b); } : i;
        ...
        CKEDITOR.dom.walker = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                checkForward: function() { return a.call(this, 0, 1) !== false; },
                checkBackward: function() { return a.call(this, 1, 1) !== false; },
                lastForward: function() { return e.call(this); },
                lastBackward: function() { return e.call(this, 1); },
                reset: function() {
                    delete this.current;
                    this._ = {};
                }
            ...
            createBookmark2: function() {
                function a(c) {
                    ...
                    if (d.type == CKEDITOR.NODE_TEXT) {
                        e = d;
                        for (m = 0; (e = e.getPrevious()) && e.type == CKEDITOR.NODE_TEXT;)m = m + e.getLength();
                        e = m;
                        if (d.getText())f = f + e;
                        else {
                            m = d.getPrevious(b);
            ...
            enlarge: function(a, b) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    var L = function(a, b) {
                        ...
                        for (c.guard = function(a) { return!(a.type == CKEDITOR.NODE_ELEMENT && a.isBlockBoundary()); }; f = c.next();) {
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var B,
                        w,
                        H = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null),
                        C = null,
                        A = function(a) {
                    ...
                    if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                        ...
                        g.evaluator = function(a) { return!x(a) && !F(a); };
                        if ((g = g.previous()) &&
    ...
    (function() {
        ...
        function b(a, c, d, f) {
            ...
            if ((h = CKEDITOR.filter.instances[f.element.data("cke-filter")]) &&
                !h.check(c))return b(a, c, d, f.remaining);
        ...
        a.prototype = {
            getNextParagraph: function(a) {
                ...
                for (this._.nextNode = null; j;) {
                    ...
                    if (E)
                        j.type == CKEDITOR.NODE_TEXT && f.test(j.getText()) &&
                        (E = 0);
                    else {
                        var n = j.getName();
                ...
                if (!this._.nextNode)
                    this._.nextNode = s || e.equals(q) || !q ? null : this._getNextSourceNode(e,
                        1, q);
                return e;
            },
            _getNextSourceNode: function(a, b, c) {
                function f(a) { return!(a.equals(c) || a.equals(e)); }
    ...
    (function() {
        ...
        function v() { return new CKEDITOR.htmlParser.element("br"); }

        function E(a) { return a.type == CKEDITOR.NODE_ELEMENT && (a.name == "br" || J.$block[a.name]); }
        ...
        function r(a, b) {
            ...
            for (e in d)
                if (e == "class") {
                    c = d[e].split(/\s+/);
                    for (j = a.classes.join("|"); k = c.pop();)if (j.indexOf(k) == -1)return false;
                } else if (a.attributes[e] != d[e])return false;
            for (n in f)if (a.styles[n] != f[n])return false;
            return true;
        }
        ...
        function M(a) { return function(b) { return r(b, a); }; }

        function D(a) { return function(b, c) { c[a](b); }; }

        var J = CKEDITOR.dtd, z = 1, L = CKEDITOR.tools.copy, B = CKEDITOR.tools.trim, w = "cke-test", H = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            ...
            applyTo: function(a, b, c, d) {
                ...
                var f = this, e = [], n = this.editor && this.editor.config.protectedSource, r, x = false, h = { doFilter: !c, doTransform: true, doCallbacks: true, toHtml: b };
                a.forEach(function(a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                ...
                for (var o,
                    ...
                    p; c = e.pop();)c.type == CKEDITOR.NODE_ELEMENT ? k(c, d, a) : c.remove();
                for (; o = a.pop();) {
                    c = o.el;
                    if (c.parent) {
    ...
    CKEDITOR.scriptLoader = function() {
        ...
        return{
            load: function(b, c, f, d) {
                ...
                h && (b = [b]);
                f || (f = CKEDITOR);
                var l = b.length, i = [], g = [], m = function(a) { c && (h ? c.call(f, a) : c.call(f, i, g)); };
                if (l === 0)m(true);
                else {
                    var t = function(a, b) {
                            (b ? i : g).push(a);
                                ...
                                if (!(d.length >
                                    ...
                                    if (c)
                                        if (CKEDITOR.env.ie && CKEDITOR.env.version < 11)
                                            ...
                                            f.$.onload = function() { setTimeout(function() { s(b, true); }, 0); };
                ...
                h = function(b) {
                    a.call(this, b, function(a) {
                        ...
                        for (m in a) {
                            ...
                            if (!e[m]) {
                                if (l.icons)for (var y = l.icons.split(","), p = y.length; p--;)CKEDITOR.skin.addIcon(y[p], l.path + "icons/" + (CKEDITOR.env.hidpi && l.hidpi ? "hidpi/" : "") + y[p] + ".png");
                                e[m] = 1;
                            }
                            if (s) {
                                s.split && (s = s.split(","));
    ...
    (function() {
        ...
        function m(a) {
            ...
            if (f)var k = RegExp("(?:^|,)(?:" + f.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(k, "");
            CKEDITOR.env.air &&
            (c = c + ",adobeair");
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var j in c) {
                    ...
                    if (u && (w = u.match(k)))for (; u = w.pop();)CKEDITOR.tools.setTimeout(function(a, b) { throw Error('Plugin "' + a.replace(",", "") + '" cannot be removed from the plugins list, because it\'s required by "' + b + '" plugin.'); }, 0, null, [u, j]);
                    if (g && !a.lang[j]) {
                        g.split && (g = g.split(","));
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml =
            function(d, h, l) {
                ...
                function g() { for (; u.length;)t(u.shift(), v); }
                ...
                function y(a, b) { return a in CKEDITOR.dtd.$listItem || a in CKEDITOR.dtd.$tableContent ? a == b || a == "dt" && b == "dd" || a == "dd" && b == "dt" : false; }
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                onText: function(a, c, f) { return this.textRules.exec(a, c, f); },
                onComment: function(a, c, f) { return this.commentRules.exec(a, c, f); },
                ...
                onAttribute: function(a, c, f, d) { return(f = this.attributesRules[f]) ? f.exec(a, d, c, this) : d; }
            }
        });
    ...
    (function() {
        function a(a, e) {
            function n(a) { return a || CKEDITOR.env.needsNbspFiller ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", { "data-cke-bogus": 1 }); }
            ...
            function w(a, b) {
                ...
                if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(j))) {
                    ...
                    if (!o)if ((c = a.previous) && c.name == "br" || !c || d(c))return true;
                }
                return false;
            }
        ...
        function g(a) { return a.replace(D, function(a, b, c) { return"<" + b + c.replace(J, function(a, b) { return z.test(b) && c.indexOf("data-cke-saved-" + b) == -1 ? " data-cke-saved-" + a + " data-cke-" + CKEDITOR.rnd + "-" + a : a; }) + ">"; }); }
        ...
        function s(a) {
            return a.replace(/<\!--(?!{cke_protected})[\s\S]+?--\>/g,
                function(a) { return"<\!--" + u + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\>"; });
        }

        function y(a) { return a.replace(/<\!--\{cke_protected\}\{C\}([\s\S]+?)--\>/g, function(a, b) { return decodeURIComponent(b); }); }
        ...
        function q(a, b) {
            for (var c = [],
                ...
                a = a.replace(/<\!--[\s\S]*?--\>/g, function(a) { return"<\!--{cke_tempcomment}" + (c.push(a) - 1) + "--\>"; }),
                j = 0; j < d.length; j++)
                a = a.replace(d[j], function(a) {
                    a = a.replace(e, function(a, b, d) { return c[d]; });
            ...
            return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function(a, c, d, f) { return"<" + c + d + ">" + p(y(f), b) + "</" + c + ">"; });
        }
    ...
    (function() {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            ...
            getFirst: function(b) {
                ...
                for (var f = 0, d = this.children.length; f < d; ++f)if (b(this.children[f]))return this.children[f];
                return null;
            },
            getHtml: function() {
    ...
    (function() {
        ...
        CKEDITOR.replace = function(b, f) { return a(b, f, null, CKEDITOR.ELEMENT_MODE_REPLACE); };
        ...
        CKEDITOR.editor.prototype.resize = function(a, b, d, e) {
            var l = this.container, i = this.ui.space("contents"), g = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement, e = e ? this.container.getFirst(function(a) { return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner"); }) : l;
    ...
    (function() {
        ...
        function h(a, b, c) { return a.config.autoParagraph !== false && a.activeEnterMode != CKEDITOR.ENTER_BR && a.editable().equals(c) && !b || b && b.getAttribute("contenteditable") == "true"; }
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            proto: {
                ...
                insertText: function(a) {
                    ...
                    if (!b) {
                        var e = /\n{2}/g;
                        if (e.test(a))var f = "<" + c + ">", r = "</" + c + ">", a = f + a.replace(e, function() { return r + f; }) + r;
                    }
                    a = a.replace(/\n/g, "<br>");
        ...
        var p = function() {
                ...
                function e(b) { return b && a(b) && (b.is(g.$removeEmpty) || b.is("a") && !b.isBlockBoundary()); }
                ...
                var g = CKEDITOR.dtd, o = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1 }, l = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, m = CKEDITOR.tools.extend({}, g.$inline);
                delete m.br;
                return function(o, z, p) {
                    ...
                    if (!w.checkReadOnly()) {
                        var C = (new CKEDITOR.dom.elementPath(w.startContainer, w.root)).blockLimit || w.root, z = { type: z, dontFilter: H, editable: o, editor: B, range: w, blockLimit: C, mergeCandidates: [], zombies: [] }, B = z.range, H = z.mergeCandidates, A, x, F, G;
                        ...
                        for (; (G = a(B.startContainer) && B.startContainer.getChild(B.startOffset - 1)) && a(G) && G.isBlockBoundary() && x.contains(G);)B.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END);
                        ...
                        for (C = A.startNode; (C = C.getParent()) && e(C);)H.push(C);
                        B.moveToBookmark(A);
                        if (A = p) {
                            A = z.range;
                            ...
                            if (/^\s+|\s+$/.test(p) && "span" in CKEDITOR.dtd[G])var y = '<span data-cke-marker="1">&nbsp;</span>', p = y + p + y;
                        ...
                        if (S)for (; I = S.pop();)CKEDITOR.env.needsBrFiller ? I.appendBogus() : I.append(K.document.createText(" "));
    ...
    (function() {
        ...
        function c(a) { return q(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? true : false; }
        ...
        function i(a) { return[{ node: a.anchorNode, offset: a.anchorOffset }, { node: a.focusNode, offset: a.focusOffset }]; }
        ...
        CKEDITOR.dom.selection.prototype =
        {
            ...
            unlock: function(a) {
                if (this.isLocked) {
                    ...
                    this.reset();
                    if (a)
                    (a = b || c[0] && c[0].getCommonAncestor()) && a.getAscendant("body",
    ...
    (function() {
                        ...
                        if (u)
                            if ((u = o.getParent()) && ((u.getDtd() || CKEDITOR.dtd.span)[f] || h) && (!g.parentRule || g.parentRule(u))) {
                                ...
                                if (s == CKEDITOR.NODE_TEXT || t || s == CKEDITOR.NODE_ELEMENT && !o.getChildCount()) {
                                    for (var s = o, U; (i = !s.getNext(J)) && (U = s.getParent(), l[U.getName()]) && (U.getPosition(n) | B) == B && (!g.childRule || g.childRule(U));)s = U;
                                    q.setEndAfter(s);
                                }
                            } else i = true;
                        else i = true;
                    ...
                    if (i && q && !q.collapsed) {
                        for (var i = j(this, d), t = i.hasAttributes(), r = q.getCommonAncestor(), s = {}, u = {}, z = {}, D = {}, O, R, X; i && r;) {
                            if (r.getName() == f) {
                                ...
                                for (R in g.styles)if (!z[R] && (X = r.getStyle(R)))i.getStyle(R) == X ? s[R] = 1 : z[R] = 1;
                            }
                            r = r.getParent();
                        }
        ...
        var r = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 },
            o =
            { a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1 },
            M = /\s*(?:;\s*|$)/,
            D = /#\((.+?)\)/g,
                ...
                return{
                    getNextRange: function(h) {
                        ...
                        if (l && a.length > 1) {
                            ...
                            if (h)
                                for (var g = 0; a[d + g + 1];) {
                                    for (var m = l.document,
                                        h = 0,
                                        i = m.getById(e[g].endNode),
                                        m = m.getById(e[g +
                                            1].startNode);;) {
                ...
                var b = a.editor,
                    a = function(a) {
                        ...
                        if (!a.getById("cke_ui_color")) {
                            ...
                            l.push(a);
                            var d = b.getUiColor();
                            d && f([a], CKEDITOR.skin.chameleon(b, "panel"), [[i, d]]);
                        }
                    };
                b.on("panelShow", a);
                b.on("menuShow", a);
...
*/
    ...
    (function() {
        ...
        function J(a) {
            ...
            f ? f.show() : (g = [
                    '<div tabIndex="-1" style="position: ', CKEDITOR.env.ie6Compat ?
            ...
            addPage: function(a) {
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    for (var b = [],
                        ...
                        { type: "vbox", className: "cke_dialog_page_contents", children: a.elements, expand: !!a.expand, padding: a.padding, style: a.style || "width: 100%;" }, b),
        ...
        var F,
            ...
            O = function(a, b, c, e, d) { (s[c] || (s[c] = [])).push({ uiElement: a, dialog: b, key: c, keyup: d || a.accessKeyUp, keydown: e || a.accessKeyDown }); },
            X = function(a) {
                for (var b in s) {
        ...
        CKEDITOR.ui.dialog.uiElement.prototype = {
            ...
            registerEvents: function(a) {
                ...
                for (d in a)
                    if (c = d.match(b))
                        this.eventProcessors[d] ? this.eventProcessors[d].call(this,
        ...
        (function() {
            ...
            CKEDITOR.dialog.validate = {
                ...
                inlineStyle: function(a) { return this.functions(function(a) { return g.test(CKEDITOR.tools.trim(a)); }, a); },
            ...
            proto: {
                ...
                showBlock: function(a, b, c, i, f, h) {
                    ...
                    this._.blurSet || (CKEDITOR.event.useCapture = !0, a.on("blur", function(a) {
                        ...
                        this.hideChild();
                        this.allowBlur(!0);
                    }, this), CKEDITOR.env.iOS && (a.on("touchstart", function() { clearTimeout(this._.hideTimeout); }, this), a.on("touchend", function() {
                        this._.hideTimeout = 0;
                        this.focus();
    ...
    (function() {
        ...
        function n(a) {
            return a._.toolbarGroups || (a._.toolbarGroups = [
                { name: "document", groups: ["mode", "document", "doctools"] }, { name: "clipboard", groups: ["clipboard", "undo"] }, { name: "editing", groups: ["find", "selection", "spellchecker"] }, { name: "forms" }, "/", { name: "basicstyles", groups: ["basicstyles", "cleanup"] }, {
                    name: "paragraph",
                    groups: [
                        "list",
    ...
    (function() {
        ...
        CKEDITOR.plugins.add("enterkey", {
            init: function(b) {
                b.addCommand("enter", { modes: { wysiwyg: 1 }, editorFocus: !1, exec: function(b) { m(b); } });
    ...
    (function() {
        function s(c) {
            function f(b) {
                ...
                for (var g = j.isIndent ? 1 : -1,
                    a = e[0],
                    e = e[e.length - 1],
                    i = CKEDITOR.plugins.list.listToArray(b, n),
                    l = i[e.getCustomData("listarray_index")].indent,
        ...
        function p(c) { return c.type == CKEDITOR.NODE_ELEMENT && c.is("li"); }

        function t(c) { return u(c) && v(c); }
            ...
            init: function(c) {
                function f(c) {
                    ...
                    this.jobs[this.isIndent ? 10 : 30] = {
                        ...
                        } : function(c, f) { return!this.getContext(f) || this.isIndent ? q : r; },
    ...
    (function() {
        ...
        function $(a) {
            ...
            if (h) {
                ...
                e.equals(a.editable[i ? "getLast" : "getFirst"](a.isRelevant)) ? (C(a), i && c.y > e.size.bottom - b && c.y < d.pane.height && e.size.bottom > d.pane.height - b && e.size.bottom < d.pane.height ? g = y : 0 < c.y &&
        ...
        CKEDITOR.plugins.add("magicline", {
            init: function(a) {
                ...
                a.on("contentDom", function() {
                    ...
                    }), d.attachListener(ea ? h : j, "mousedown", function() { "wysiwyg" == a.mode && (b.line.detach(), b.hiddenMode = 1, b.mouseDown = 1); }), d.attachListener(ea ? h : j, "mouseup", function() {
                        b.hiddenMode = 0;
                        b.mouseDown = 0;
            ...
            removeformat: {
                exec: function(a) {
                    for (var h = a._.removeFormatRegex || (a._.removeFormatRegex = RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), e = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), f = CKEDITOR.plugins.removeformat.filter, k = a.getSelection().getRanges(), l = k.createIterator(), m = function(a) { return a.type == CKEDITOR.NODE_ELEMENT; }, c; c = l.getNextRange();) {
                        ...
                        var j = c.createBookmark(), b = j.startNode, d = j.endNode, i = function(b) { for (var c = a.elementPath(b), e = c.elements, d = 1, g; (g = e[d]) && !g.equals(c.block) && !g.equals(c.blockLimit); d++)h.test(g.getName()) && f(a, g) && b.breakParent(g); };
                        i(b);
                        if (d) {
                            i(d);
                            for (b = b.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT); b && !b.equals(d);)
                                if (b.isReadOnly()) {
                                    ...
                                    i = b.getNextSourceNode(!1, CKEDITOR.NODE_ELEMENT), !("img" == b.getName() && b.data("cke-realelement")) && f(a, b) && (h.test(b.getName()) ?
    ...
    CKEDITOR.plugins.add("scayt", {
        ...
        bindEvents: function(a) {
            ...
            CKEDITOR.on("dialogDefinition", function(a) {
                if ("scaytDialog" ===
                    a.data.name)a.data.definition.dialog.on("cancel", function() { return!1; }, this, null, -1);
            });
                    ...
                    d.attachListener(d, "focus", function() {
                        ...
                        if ((b || d) && a._.savedSelection)
                            for (var d = a._.savedSelection.getSelectedElement(), d = !d && a._.savedSelection.getRanges(), i = 0; i < d.length; i++)
                                e = d[i], c = e.startContainer.getText().length,
            ...
            a.on("beforeCommandExec", function(b) {
                ...
                if (b.data.name in d.options.disablingCommandExec && "wysiwyg" == a.mode) {
                    ...
                    "superscript" === b.data.name)if (c = a.scayt)c.removeMarkupInSelectionNode(), setTimeout(function() { c.fire("startSpellCheck"); }, 0);
            });
            ...
            a.on("afterCommandExec", function(d) {
                ...
                (b = a.scayt) && setTimeout(function() { b.fire("startSpellCheck"); },
                    250);
            });
        ...
        parseConfig: function(a) {
            ...
            if (void 0 === a.config.scayt_userDictionaryName || "string" !== typeof a.config.scayt_userDictionaryName)
                a.config.scayt_userDictionaryName =
                    null;
            ...
            if (a.config.scayt_disableOptionsStorage) {
                ...
                a.config.scayt_disableOptionsStorage = function(a) {
                    for (var d = [], b = 0; b < a.length; b++) {
                        ...
                        if (!f(e, c) || j && f(g, function(a) { if (a === "lang")return false; }))return;
        ...
        buildSuggestionMenuItems: function(a,
            ...
            if (0 < c.length && "no_any_suggestions" !== c[0])
                for (var g = 0; g < c.length; g++) {
                    ...
                    (a.addMenuItem("scayt_moresuggest", { label: e.getLocal("btn_moreSuggestions"), group: "scayt_moresuggest", order: 10, getItems: function() { return b; } }), d.scayt_moresuggest = CKEDITOR.TRISTATE_OFF));
                }
        ...
        if (!0 === CKEDITOR.config.scayt_handleCheckDirty) {
            ...
            a.checkDirty = CKEDITOR.tools.override(a.checkDirty, function(a) {
                return function() {
                    ...
                    else if (b = "ready" == this.status)var g = c.removeMarkupFromString(this.getSnapshot()), c = c.removeMarkupFromString(this._.previousValue), b = b && c !== g;
                    return b;
                };
            });
                    ...
                    if (b = b.data.styles) {
                        for (var a, h, d, e = 0, l = b.length; e < l; e++)
                            if (a = b[e], !(c.blockless && a.element in CKEDITOR.dtd.$block) && (h = a.name, a = new CKEDITOR.style(a), !c.filter.customConfig || c.filter.check(a)))
                                a._name = h, a._.enterMode = j.enterMode, a._.type = d = a.assignedTo || a.type, a._.weight = e + 1E3 * (d == CKEDITOR.STYLE_OBJECT ? 1 : d == CKEDITOR.STYLE_BLOCK ? 2 : 3),
        ...
        function q(e) {
            if (e instanceof CKEDITOR.dom.selection) {
                for (var d = p(e), b = d[0].getAscendant("table"), c = CKEDITOR.tools.buildTableMap(b), e = d[0].getParent().$.rowIndex, d = d[d.length - 1], a = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = [], f = e; f <= a; f++) {
                    for (var g =
                                 c[f],
                        h = new CKEDITOR.dom.element(b.$.rows[f]),
                        i = 0; i < g.length; i++) {
                ...
                b("columnDelete", d({
                    ...
                    exec: function(a) {
                        for (var a = a.getSelection(),
                            ...
                            l = [],
                            n = 0,
                            o = d.length; n < o; n++)for (var k = 0, q = d[n].length; k < q; k++)d[n][k] == b.$ && (e = k), d[n][k] == c.$ && (j = k);
        ...
        i.prototype = {
            ...
            attachListeners: function() {
                ...
                b.attachListener(this.undoManager.editor,
                    "blur", function() { c.keyEventsStack.remove(9); }, null, null, 999);
            }
        };
        var k = CKEDITOR.plugins.undo.KeyEventsStack = function() { this.stack = []; };
        k.prototype = {
            push: function(a) { return this.stack[this.stack.push({ keyCode: a, inputs: 0 }) - 1]; },
