...
(function($) {
    ...
    var Slider = function(element, options) {
        ...
        case 'vertical':
            this.picker.addClass('slider-vertical ios-slider');
            this.stylePos = 'top';
            this.mousePos = 'pageY';
        ...
        default:
            this.picker
                .addClass('slider-horizontal ios-slider')
                .css('width', origWidth);
    ...
    function createNewSliderInstance(opts) {
        ...
        $this.each(function() {
            ...
            if (slider && !options) {
                ...
                $.each($.fn.sliderIOS.defaults, function(key) {
                    options[key] = slider[key];
                });
            }

            $this.data('slider', (new Slider(this, $.extend({}, $.fn.sliderIOS.defaults, options))));
        });
        return $this;
    }

    $.fn.sliderIOS.defaults = {
        min: 0,
        max: 10,
        step: 1,
    ...
    $.fn.sliderIOS.Constructor = Slider;
